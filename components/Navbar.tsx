...
import { CogSolidIcon } from './icons/CogSolidIcon'; // Changed from Cog6ToothIcon
import { XMarkIcon } from './icons/XMarkIcon';
import { SunIcon } from './icons/SunIcon';
import { MoonIcon } from './icons/MoonIcon';
import { ShoppingBagIcon } from './icons/ShoppingBagIcon'; // New icon for Store
...
const navItems = [
  ...
  { to: AppView.REWARDS, label: 'Tienda', icon: <ShoppingBagIcon /> }, // Changed label and icon
