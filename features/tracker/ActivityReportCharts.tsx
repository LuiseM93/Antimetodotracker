...
import { CATEGORY_COLORS_CHART_HEX, ANTIMETHOD_ACTIVITIES_DETAILS, SKILL_COLORS_CHART_HEX, COLORS } from '../../constants';
...
export const ActivityReportCharts: React.FC<ActivityReportChartsProps> = ({ logs, selectedLanguage, dateRange }) => {
  ...
  const chartPrimaryLineBarColor = appTheme === 'dark' ? '#bb86fc' : COLORS.accent; // Light theme uses COLORS.accent
