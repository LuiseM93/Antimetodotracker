...
export const SettingsScreen: React.FC = () => {
  ...
  const [dashboardCardMode, setDashboardCardMode] = useState<DashboardCardDisplayMode>(userProfile?.dashboardCardDisplayMode || 'both');
  ...
  useEffect(() => {
    if (userProfile) {
        ...
        setDashboardCardMode(userProfile.dashboardCardDisplayMode || 'both');
    }
  }, [userProfile]);
        ...
        <div className="space-y-6">
          ...
          <div>
            ...
            <select
              ...
              className={inputBaseStyle}
            >
              <option value="both">Ambas (Salud de Hábitos y Racha, separadas)</option>
              <option value="health_only">Solo Salud de Hábitos</option>
              <option value="streak_only">Solo Racha Diaria</option>
