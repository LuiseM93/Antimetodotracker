...
import { AntimethodStage, DailyActivityGoal, ActivityCategory, Resource, Skill, ActivityDetailType } from './types';
...
export const ONBOARDING_SCREENS = [
  ...
  },
  {
    ...
    text: "Esta app es tu centro de mando para registrar tu inmersión, visualizar tu progreso y encontrar recursos. Es 100% gratuita y sin anuncios."
  },
  {
...
export const INITIAL_RESOURCES: Resource[] = [
  ...
  { id: 'resX09', name: 'Base de Recursos de la Comunidad Refold (Varios Idiomas)', category: 'Apoyo Extra y Guías Adicionales', subCategory: 'Bases de Datos de Recursos Comunitarios', description: 'Recursos comunitarios de Refold para varios idiomas.', link: 'https://refold.la/community/document/5xvbdNboPSxL92N03iR4', isCommunityRecommended: true },
];
...
export const AVAILABLE_LANGUAGES_FOR_LEARNING = [
  "Español", "English", "Français", "Deutsch", "Italiano", "Português", "日本語", "한국어", "中文"
]; 
