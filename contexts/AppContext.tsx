...
import { UserProfile, ActivityLogEntry, Language, AntimethodStage, UserGoal, DailyActivityGoal, Resource, SavedDailyRoutine, AppDataExport, TimerMode, AppTheme, AppView, YearInReviewData, ActivityCategory, Skill, ActivityDetailType } from '../types';
...
export const AppContextProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const getYearInReviewData = useCallback((year: number, languageFilter: Language | 'Total'): YearInReviewData => {
    ...
    yearlyLogs.forEach(log => {
      ...
      } else { // Fallback if skill not explicitly defined for subActivity
          switch(log.category) {
