...
import { LearningDaysCard } from './LearningDaysCard'; // New card for learning days
import { STAGE_DETAILS, AVAILABLE_LANGUAGES_FOR_LEARNING, HABIT_POINTS_MAP } from '../../constants';
import { ActivityLogEntry, AntimethodStage, Language, AppView, DailyActivityGoal, DashboardCardDisplayMode, UserProfile } from '../../types';
