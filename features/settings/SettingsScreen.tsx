  ...
  const handlePreferencesSave = () => {
    if (userProfile) {
        ...
        if (currentLearningLanguages.length > 0 && !currentLearningLanguages.includes(primaryLanguage)) {
            ...
            // If all learning languages were removed, this case might need specific handling,
            // e.g., forcing at least one language or resetting primary to a global default.
            // For now, AppContext should handle this.
